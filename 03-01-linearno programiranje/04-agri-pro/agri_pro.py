...
# Overall production
m.add_constraints(x1 + x2 + x3 + x4 == 8000)

# mix consists of at least 20% corn  
m.add_constraints((0.3*x1 + 0.05*x2 + 0.2*x3 + 0.1*x4)/8000 >= 0.2)

# mix consists of at least 15% grain  
m.add_constraints((0.1*x1 + 0.3*x2 + 0.15*x3 + 0.1*x4)/8000 >= 0.15)

# mix consists of at least 15% minerals  
m.add_constraints((0.2*x1 + 0.2*x2 + 0.2*x3 + 0.3*x4)/8000 >= 0.15)

m.add_objective( 0.25*x1 + 0.30*x2 + 0.32*x3 + 0.15*x4)
